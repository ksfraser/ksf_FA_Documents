...
CREATE TABLE IF NOT EXISTS `0_fa_documents` (
...
CREATE TABLE IF NOT EXISTS `0_fa_document_attachments` (
    `id` INT(11) NOT NULL AUTO_INCREMENT,
    ...
    FOREIGN KEY (`doc_id`) REFERENCES `0_fa_documents`(`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Document acknowledgments
CREATE TABLE IF NOT EXISTS `0_fa_document_acknowledgments` (
    `id` INT(11) NOT NULL AUTO_INCREMENT,
    `doc_id` INT(11) NOT NULL,
...
-- Document versions
CREATE TABLE IF NOT EXISTS `0_fa_document_versions` (
    `id` INT(11) NOT NULL AUTO_INCREMENT,
    `doc_id` INT(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `0_fa_document_links` (
...
INSERT INTO `0_fa_document_links` (doc_id, entity_type, entity_id, created_at)
