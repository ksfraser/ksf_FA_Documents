<?php
/**
 * ksf_FA_Documents Module Hooks for FrontAccounting
 */

define('SS_ksf_FA_Documents', 100 << 8);
...
class hooks_ksf_FA_Documents extends hooks {
    ...
    function install_access() {
        ...
        $security_areas['SA_ksf_FA_DocumentsVIEW'] = array(SS_ksf_FA_Documents | 1, _("View "));
        $security_areas['SA_ksf_FA_DocumentsMANAGE'] = array(SS_ksf_FA_Documents | 2, _("Manage "));
